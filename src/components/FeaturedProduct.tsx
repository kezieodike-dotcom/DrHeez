    ...
    <section className="py-20 bg-white px-4 sm:px-6 lg:px-8 border-b border-gray-100" id="featured-product-highlights">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-brand-light border border-gray-200/50 rounded-3xl p-8 lg:p-12 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* visual image render - Column Left */}
          ...
          {/* Copy description and benefits grid - Column Right */}
          <div className="lg:col-span-7 space-y-6">
            ...
            {/* Itemized benefits list from PRD */}
            <div>
            ...
            {/* Scientific Notice required by PRD */}
            <div className="bg-amber-50 border-l-4 border-amber-500 text-amber-900 rounded-r-xl p-4 text-xs italic leading-relaxed space-y-1">
              <strong className="font-display font-bold block text-amber-950 not-italic">⚠️ Important Notice:</strong>
            ...
            <div className="pt-6 border-t border-gray-200/60 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => onInstantBuyWhatsApp(megaProduct, 1)}
                  className="bg-brand-gold hover:bg-brand-gold-hover text-brand-green font-extrabold text-xs py-3.5 px-6 rounded-xl flex items-center gap-2 shadow cursor-pointer transition-all"
                  id="featured-wa-order"
                >
